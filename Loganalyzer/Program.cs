...
class LogAnalyzer
{
    ...
    static DateTime ParseDateFromLogLine(string logLine)
    {
        ...
        string dateTimePart = logLine.Substring(10, 24); // "2024-06-07 10:00:00" formatında

        if (DateTime.TryParse(dateTimePart, out DateTime logDateTime))
        {
            return logDateTime;
        }

        throw new FormatException("Geçersiz tarih formatı: " + dateTimePart);
    }
}*/
using System;
using System.Collections.Generic;
